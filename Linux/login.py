...
driver = webdriver.Chrome(executable_path="/home/chuck/Desktop/python-projects/calendar/chromedriver")
...
df.to_csv('/home/chuck/Desktop/python-projects/calendar/table.csv', index=False)

### Close the browser ####
driver.close()

# #### Use Panda to compare new and old csv files ####
f1 = pd.read_csv("/home/chuck/Desktop/python-projects/calendar/table.old.csv", encoding = 'ISO-8859-1')
f2 = pd.read_csv("/home/chuck/Desktop/python-projects/calendar/table.csv", encoding = 'ISO-8859-1')
...
def dataframe_difference(df1, df2):
   ### returning rows that are only in new table ###
    ...
    diff_df.to_csv('/home/chuck/Desktop/python-projects/calendar/update.csv', index=False)
    return diff_df
dataframe_difference(f2, f1)


#### Saving new csv as old.csv for future comparisons ####
f2.to_csv('/home/chuck/Desktop/python-projects/calendar/table.old.csv', index=False)

diff_df = pd.read_csv('/home/chuck/Desktop/python-projects/calendar/update.csv', encoding= 'ISO-8859-1')

#### If any new work orders have been assigned send email notification ####
if os.path.getsize('/home/chuck/Desktop/python-projects/calendar/update.csv') > 64:
    email_address = ""
    email_password = ""
    msg = EmailMessage()
    ...
    files = ['/home/chuck/Desktop/python-projects/calendar/update.csv']
    for file in files:
